...
public class FrameworkPermissionStore : IPermissionStore, ITransientDependency
{
    ...
    public FrameworkPermissionStore(
        ILogger<FrameworkPermissionStore> logger,
        ...
        string providerKey)
    {
        ...
        Logger.LogDebug($"MyPermissionStore.GetCacheItemAsync: {cacheKey}");
        ...
        PermissionGrantCacheItem currentCacheItem)
    {
        ...
        var grantedPermissions =
            await PermissionClient.GetGrantedPermissionsAsync(
                providerName,
                providerKey);
        ...
        string providerKey)
    {
        ...
        Logger.LogDebug($"MyPermissionStore.GetCacheItemAsync: {string.Join(",", cacheKeys)}");
