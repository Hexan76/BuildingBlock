...
{
    Task<PagedResult<TEntity>> PaginationAsync(FilterGroup filterGroup, int skip = 0, int maxResultCount = 10, string sort = "");
    Task<PagedResult<TEntity>> PaginationPagingAsync(FilterGroup filterGroup, int page = 1, int pageSize = 10, string sort = "");
}
